...
void Laborator5::Update(float deltaTimeSeconds)
{
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(-1.5, 2.5f, 0));
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(1.5f, 2.5f, 0));
	...
	{
		projectionMatrix = glm::ortho(-5.0f - orthoTransX, 5.0f + orthoTransX, -5.0f - orthoTransY, 5.0f + orthoTransY, 0.01f, 200.0f);
	}
}
