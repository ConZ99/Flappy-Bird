...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	if (angularStep > 360)
		angularStep = (int)angularStep % 360;
	else
		angularStep += deltaTimeSeconds;

	modelMatrix = glm::mat3(1);
	modelMatrix = modelMatrix * Transform2D::Translate(150, 250) * Transform2D::Translate(translateX, translateY);
	...
	modelMatrix = glm::mat3(1);
	modelMatrix = Transform2D::Translate(650, 250) * Transform2D::Translate(-250, 0) * Transform2D::Rotate(angularStep) * Transform2D::Translate(250, 0);
